package com.example.giftyhaus.ui.theme.screens.register
...
import com.example.giftyhaus.data.AuthViewModel
import com.example.giftyhaus.navigation.ROUTE_LOGIN
...
fun RegisterScreen(navController: NavController){
    ...
    Column(modifier = Modifier.fillMaxWidth().fillMaxHeight(), verticalArrangement = Arrangement.Center) {
        ...
        Image(painter = painterResource(id = R.drawable.logo), contentDescription = "logo", modifier = Modifier.wrapContentHeight().fillMaxWidth().height(40.dp))
